...
import { CardsType, useCardsLyaout4 as useCardsLyaout1 } from '../../state/useCards';

import styles from './CardLayout6.module.scss';
...
const CardsDefault = () => {
  ...
  const getCardType = (type: CardsType) => {
    if (drop1Card === type || drop2Card === type || drop3Card === type) {
      return false;
    } else {
      return true;
    }
  ...
  return (
    <div className={styles.cardWrapper}>
      <div className={styles.card}>
        {getCardType(1) && (<img src={Card1} className={styles.cardItemDefault} draggable={false} />)}
      </div>
      <div className={styles.card}>
        {getCardType(2) && (<img src={Card2} className={styles.cardItemDefault} draggable={false} />)}
      </div>
      <div className={styles.card}>
        {getCardType(3) && (<img src={Card3} className={styles.cardItemDefault} draggable={false} />)}
      </div>
      <div className={styles.card}>
        {getCardType(4) && (<img src={Card4} className={styles.cardItemDefault} draggable={false} />)}
      </div>
      <div className={styles.card}>
        {getCardType(5) && (<img src={Card5} className={styles.cardItemDefault} draggable={false} />)}
      </div>
