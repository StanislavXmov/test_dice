...
import { CardsType, useCardsLyaout3 as useCardsLyaout1} from '../../state/useCards';

import styles from './CardLayout3.module.scss';
  ...
  return (
    <div className={styles.layer}>
      ...
      <div className={styles.submitWrapper}>
        ...
        >
          Другой набор
          <ResetIcon className={styles.submitResetIcon}/>
        </button>
      </div>
    </div>
  );
